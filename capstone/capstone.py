...
cv_window_name = 'Capstone - Q to quit'
...
def print_usage():
    print('\nusage: ')
    print('python3 Capstone.py [help][googlenet=on|off][resize_window=<width>x<height>]')
    print('')
    print('options:')
    ...
    print('')
    print('Example: ')
    print('python3 Capstone.py googlenet=on resize_window=1920x1080')

# prints information for the user when program starts.
def print_info():
    print('Running Capstone')
    print('Keys:')
    print("  'Q'/'q' to Quit")
