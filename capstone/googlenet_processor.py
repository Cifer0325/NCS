    ...
    def _do_work(self):
        ...
        while (not self._end_flag):
            try:
                ...
                print("if you want to add more NCSs with ty_YOLO_net, please input '1'")
                print("if you want to add more NCSs with googlnet, please input '2' ")
            except queue.Full:
                print('googlenet processor has been applied successfully')
